...
class DataPusher:
    def __init__(self, db_name):
        ...
        self.table_fields = {
            ...
            'place': ['id', 'type', 'subtype', 'name', 'description', 'subdescription', 'address', 'rental_period', 'price', 'photo_path', 'locker_rooms', 'shower', 'parking', 'inventory'],
            'reservation': ['id', 'place_id', 'user_id','start_date', 'finish_date'],
            'cancellation': ['id','reservation_id'],
            'helper_log': ['id', 'branch_id','user_id', 'helper_id', 'message', 'is_question'],
            'Helper': ['id', 'login', 'fullname']
        }
